...
parser.add_argument('--bam_file','-b', help="bam file, called by longranger align",required=True)
parser.add_argument('--out_dir','-o', help="output folder for assembly results, default = ./Assembly_results",default="./Asssembly_results")
parser.add_argument('--num_threads_for_bwa_mem','-t',type=int, help=" The number of threads you can define for samtoos sort, default = 20",default=20)
