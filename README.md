...
*We provide  <a href="https://github.com/maiziex/Aquila_stLFR/blob/master/example_data/run_example_data.md">a small chromosome's (chr21) example dataset</a> to run the whole pipeline before you try it to the large dataset. 
