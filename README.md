...
```
#### *Required parameters
##### --fastq_file: "S12878.fastq" is the stLFR fastq file (with BX:Z:barcode at the header, check examples <a href="https://github.com/maiziex/Aquila_stLFR/blob/master/src/How_to_get_bam_and_vcf.md">here</a>)
