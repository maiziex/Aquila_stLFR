...
We also provide  <a href="https://github.com/maiziex/Aquila_stLFR/blob/master/src/How_to_get_bam_and_vcf.md">a small chromosome's (chr21) example dataset</a>) to run the whole pipeline before you dive into the large dataset. 
